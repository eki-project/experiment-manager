...
# Start 4 agents, one on each GPU
SWEEP_ID=$1
CUDA_VISIBLE_DEVICES=0 wandb agent felixj/RadioML/$SWEEP_ID &
CUDA_VISIBLE_DEVICES=1 wandb agent felixj/RadioML/$SWEEP_ID &
CUDA_VISIBLE_DEVICES=2 wandb agent felixj/RadioML/$SWEEP_ID &
CUDA_VISIBLE_DEVICES=3 wandb agent felixj/RadioML/$SWEEP_ID &
wait
